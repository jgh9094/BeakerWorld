...
EMP_BUILD_CONFIG( BeakerWorldConfig,
  ...
  VALUE(PROGRAM_MIN_FUN_LEN,   size_t, 16,  "Minimum number of instructions in a SignalGP function."),
  ...
  VALUE(RADIUS_MUT, double, 0.01, "Rate of tag bit-flip mutations (per bit)."),
