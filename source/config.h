...
EMP_BUILD_CONFIG( BeakerWorldConfig,
  ...
  VALUE(INIT_POP_SIZE,  size_t, 50, "How many organisms should we start with?"),  
  VALUE(MAX_POP_SIZE,   size_t, 100, "What are the most organisms that should be allowed in pop?"),
  ...
  VALUE(NUM_RESOURCE_SOURCES,  size_t, 40, "How many sources of resouces should there be?"),
