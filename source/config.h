...
EMP_BUILD_CONFIG( BeakerWorldConfig,
  ...
  VALUE(INIT_POP_SIZE,  size_t, 900, "How many organisms should we start with?"),  
  ...
  VALUE(NUM_RESOURCE_SOURCES,  size_t, 400,      "How many sources of resouces should there be?"),
  ...
  VALUE(RESOURCE_POWERUP,      double, 500.0,    "Energy gained from eating a resource"),
  VALUE(REPRODUCTION_PENALTY,  double, 500.0,    "Energy lost by producing offspring"),
